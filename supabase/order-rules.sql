-- Reglas de pedido · SQL Editor → New query → Run
-- Cooldown 2 h y cancelar solo si sigue en pendiente (recibido)
...
begin
  ...
  -- Cooldown 2 h (desactivado para pruebas con el mismo celular)
...
begin
  ...
  update public.orders set status = 'cancelado' where id = p_id;
